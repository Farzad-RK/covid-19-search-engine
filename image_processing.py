...
# For the purpose of feeding images to convolutional network, they should have the same size
def resize_image(image):
    dimensions = (224, 224)
    return cv2.resize(image, dimensions, interpolation=cv2.INTER_AREA)


# Contrast Limited Adaptive Histogram Equalization to enhance the contrast of the images.
...
def batch_enhancement_and_resize(source_path, target_path, extension="png", process_all=False, batch_size=100):
    ...
    # We use lungmask trained with U-net neural network to segment the lungs and generate masks
